...
class InsertStudent2 extends StatefulWidget {
  const InsertStudent2({super.key});

  @override
  State<InsertStudent2> createState() => _InsertStudent2State();
}

class _InsertStudent2State extends State<InsertStudent2> {
  ...
  dbInsertAction() async {
    ...
    if (result == 'success') {
      ...
      var url = Uri.parse(
          'http://localhost:8080/Flutter/MustEatPlace/insert_musteat_list.jsp?name=$name&phone=$phone&lat=$latData&lng=$longData&image=$imageName&estimate=$estimate&initdate=$initdate');
